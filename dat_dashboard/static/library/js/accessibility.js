    ...
    (e, t, i, s, n, r, o, a, l, h, c) =>
      (() => {
          ...
          init(e, t) {
            ...
            (this.chart = e),
              ...
              ["mouseup", "touchend"].forEach((e) =>
                i.addEvent(eV, e, (e) => this.onMouseUp(e))
              ),
          ...
          e.compose = function (e) {
            ...
            return (
              !s.dismissPopupContent &&
                ((s.dismissPopupContent = t), eV && eY(eV, "keydown", i)),
              e
            );
          };
        })(eQ || (eQ = {}));
        ...
        class ip {
          ...
          destroy() {
            ...
            e.removeEvents(),
              ...
              t &&
                e === t.scrollbar &&
                ((t.scrollbar = null), io(t.scrollbarButtons));
          }
        ...
        class iR {
              ...
              e.adaptToUpdatedData &&
                this.baseSeries.forEach((e) => {
                  e.eventsToUnbind.push(
                    iv(e, "updatedData", this.updatedDataHandler)
                  );
                }, this),
          ...
          render(e, t, i, s) {
            ...
            let v =
              (this.size =
              x =
                iB(r.len, (c ? n.plotHeight : n.plotWidth) - 2 * p));
            (g = c ? f : x + 2 * p),
          ...
          removeBaseSeriesEvents() {
            ...
            this.navigatorEnabled &&
              ...
              e[0].xAxis &&
                iI(e[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes));
          }
          getXAxisOffsets() {
            ...
            return (
              (e && null === i.dataMin) ||
                (t = {
                  dataMin: iB(
                    s.parse(r?.min),
                    iO("min", s.parse(o.min), i.dataMin, n.dataMin, n.min)
                  ),
                  dataMax: iB(
                    s.parse(r?.max),
                    iO("max", s.parse(o.max), i.dataMax, n.dataMax, n.max)
                  ),
                }),
              t
            );
          ...
          setBaseSeries(e, t) {
            ...
            (e =
              ...
              (i.series.length
                ? ik(i.series, (e) => !e.options.isInternal).index
                : 0)),
            ...
            let i = this,
              ...
              o = (i.series = (i.series || []).filter((e) => {
                ...
                return (
                  !(0 > n.indexOf(t)) ||
                  (t &&
                    (iI(t, "updatedData", i.updatedDataHandler),
          ...
          addBaseSeriesEvents() {
            ...
            t[0] &&
              ...
              t[0].eventsToUnbind.push(
                iv(t[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)
              ),
              t.forEach((i) => {
                i.eventsToUnbind.push(
                  ...
                  !1 !== this.navigatorOptions.adaptToUpdatedData &&
                    i.xAxis &&
                    i.eventsToUnbind.push(
                      iv(i, "updatedData", this.updatedDataHandler)
                    ),
                  i.eventsToUnbind.push(
                    iv(i, "remove", function () {
                      t && iC(t, i),
                        this.navigatorSeries &&
                          ...
                          iA(this.navigatorSeries.options) &&
                  ...
                  ((e) => {
                    ...
                    if (i && s && this.minHandleProxy && this.maxHandleProxy) {
                      ...
                      this.announcer.announce(
                        iH(a, { axisRangeDescription: l, chart: t }, t)
                      );
                    }
                  }).bind(this, e),
                  20
        ...
        let st = {
          ...
          { getChartTitle: so } = K,
          {
            defaultPointDescriptionFormatter: sa,
            defaultSeriesDescriptionFormatter: sl,
          } = st;
        function sh(e) {
        ...
        !(function (e) {
          function t(e) {
            ...
            i &&
              i.chart === t &&
              sh(t) &&
              (i.dirty.newPoint = sn(i.dirty.newPoint) ? void 0 : e.point);
          }
          function i() {
            let e = this.chart,
          ...
          e.compose = function (e) {
            sr(si, "A11y.NDA") &&
              (ss(e, "addPoint", t), ss(e, "updatedData", i));
          };
        })(sc || (sc = {}));
        let sd = sc,
          { doc: su, win: sp } = w(),
        ...
        !(function (e) {
          ...
          e.compose = function (e, s) {
            ...
            n.highlightRangeSelectorButton ||
              ((n.highlightRangeSelectorButton = t), sN(s, "afterBtnClick", i));
          };
        })(sI || (sI = {}));
        let sF = sI,
          { composed: sO } = w(),
        ...
        !(function (e) {
          ...
          function r(e) {
            this.resetA11yMarkerOptions = sL(
              e.options.marker || {},
          ...
          function a() {
            this.boosted &&
              this.a11yMarkersForced &&
              (sL(!0, this.options, { marker: { enabled: !1 } }),
              delete this.a11yMarkersForced);
          }
          e.compose = function (e) {
            sH(sO, "A11y.FM") &&
        ...
        let { seriesTypes: sW } = tF(),
          ...
          {
            getPointFromXY: sj,
            getSeriesFromName: s_,
            scrollAxisToPoint: sZ,
          } = K;
        function s$(e) {
          let t = e.index,
            i = e.series.points,
        ...
        !(function (e) {
          ...
          function r() {
            ...
            if (i && s) {
              for (let e = t; e < s; ++e)
                if (!sJ(i[e])) return i[e].highlight();
              for (let e = t; e >= 0; --e)
                if (!sJ(i[e])) return i[e].highlight();
            }
            return !1;
          ...
          no = {
            isHighContrastModeActive: function () {
              if (nn && nr.getComputedStyle) {
                ...
                let t = (e.currentStyle || nr.getComputedStyle(e))
                  .backgroundImage;
                return ns.body.removeChild(e), "none" === t;
              }
              return (
                nr.matchMedia &&
                nr.matchMedia("(forced-colors: active)").matches
              );
            },
        ...
        let nu = function (e) {
            ...
            ["description", "typeDescription"].forEach(function (s) {
              t[s] &&
                ((i[s] = t[s]),
                nl(32, !1, e, { [`chart.${s}`]: `use accessibility.${s}` }));
            }),
