!(
   ...
   */ (function (t, e) {
    "object" == typeof exports && "object" == typeof module
      ...
      : (t.Highcharts = e(t.Highcharts, t.Highcharts.AST, t.Highcharts.Chart));
    ...
    (() => {
      ...
      function f(t) {
        ...
        if (
          ...
          return u.createObjectURL(new d.Blob([o], { type: e[1] }));
        }
      }
      let m = {
        dataURLtoBlob: f,
      ...
      !(function (t) {
        ...
        function o(t, e) {
          ...
          try {
            ...
            return o.createObjectURL(new C.Blob(["\uFEFF" + t], { type: e }));
          } catch (t) {}
        }
        function n(t) {
          let e = "",
            ...
            n = N(
              o?.decimalPoint,
              o?.itemDelimiter !== "," && t ? (1.1).toLocaleString()[1] : "."
            ),
        ...
        function i(t) {
          let e,
            ...
            c = [],
            d = [],
            p = o.options.lang.exportData,
            g = p?.categoryHeader,
            u = p?.categoryDatetimeHeader,
            f = function (e, a, o) {
            ...
            if (
              ...
              (w = {
                ...
                e.options.data?.forEach(function (t, a) {
                  ...
                  for (
                    s[l].x = f.x, s[l].name = x, s[l].xValues[u] = f.x;
                    v < p;

                  )
                    (c = h[v]),
                      (d = e.pointClass.prototype.getNestedProperty.apply(f, [
                        c,
                      ])),
                      (s[l][D + v] = N(
                        y.categoryMap[c][d],
                        y.dateTimeValueAxisMap[c]
                          ? i.dateFormat(r.dateFormat, d)
                          : null,
                        d
                      )),
                      v++;
                ...
                y &&
                  ...
                  (y.dateTime
                    ? (t.x instanceof Date && (t.x = t.x.getTime()),
                      (e = i.dateFormat(r.dateFormat, t.x)))
                    : (e = y.categories
                        ? N(y.names[t.x], y.categories[t.x], t.x)
                        : t.x)),
                  t.splice(a, 0, e);
              });
          return k(o, "exportData", { dataRows: (w = w.concat(h)) }), w;
        }
        function r(t) {
          let e = (t) => {
        ...
        function l(t) {
              ...
              return (
                "number" == typeof n
                  ? ((n = n.toString()),
                    "," === r && (n = n.replace(".", r)),
                    (i = "highcharts-number"))
                  : o || (i = "highcharts-empty"),
                {
                  tagName: t,
                  attributes: (a = R({ class: i }, a)),
                  textContent: n,
                }
              );
            },
          ...
          !1 !== g &&
            a.push({
              ...
              textContent:
                "string" == typeof g ? g : i.title?.text || i.lang.chartTitle,
            });
            ...
            (function (t, e, a) {
              ...
              if (e) {
                ...
                for (i = 0, r = e.length; i < r; ++i)
                  void 0 !== e[i] &&
                    t.push(p("th", null, { scope: "col" }, e[i]));
          ...
          s.forEach(function (t) {
            let a = [];
            for (let o = 0; o < e; o++)
              a.push(p(o ? "td" : "th", null, o ? {} : { scope: "row" }, t[o]));
            u.push({ tagName: "tr", children: a });
          }),
            a.push({ tagName: "tbody", children: u });
          let f = {
            tree: {
              tagName: "table",
        ...
        function h(t) {
          ...
          if (
            (a &&
              ...
              e.renderTo.parentNode.insertBefore(
                this.dataTableDiv,
                e.renderTo.nextSibling
              )),
            this.dataTableDiv)
          ) {
            ...
            (o.display = t ? "block" : "none"),
              t
                ? ((this.dataTableDiv.innerHTML = b().emptyHTML),
        ...
        t.compose = function (t, o, f) {
          ...
          if (!m.downloadCSV) {
            ...
            x && (x.prototype.keyToAxis = { low: "y", high: "y" }),
              b &&
                ((b.prototype.exportKey = "name"),
                (b.prototype.keyToAxis = { start: "x", end: "x" })),
              y && (y.prototype.exportKey = "name"),
              w && (w.prototype.exportKey = "name"),
              S && (S.prototype.exportKey = "name"),
              L && (L.prototype.keyToAxis = { x2: "x" });
          }
        };
      })(o || (o = {}));
      let F = o,
