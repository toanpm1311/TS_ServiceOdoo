    ...
    (() => {
      ...
      function v(e) {
        ...
        if (
          ...
          return w.createObjectURL(new x.Blob([i], { type: t[1] }));
        }
      }
        ...
        { downloadURL: U, getScript: I } = {
          ...
          downloadURL: function (e, t) {
            ...
            if (void 0 !== i.download)
              ...
              try {
                if (!x.open(e, "chart")) throw Error("Failed to open window");
              } catch {
                x.location.href = e;
              }
          },
      ...
      class eh {
            ...
            try {
              ...
              if (n && i && l) {
                ...
                (t.width = c),
                  (t.height = h),
                  q.canvg ||
                    ((eh.objectURLRevoke = !0), await I(a + "canvg.js")),
          ...
          r && r.body.appendChild(r.createElementNS($, "svg")),
            !(function o(s) {
              ...
              if (
                r &&
                1 === s.nodeType &&
                -1 === eh.unstyledElements.indexOf(s.nodeName)
              ) {
                if (
                  ((a = q.getComputedStyle(s, null)),
                  (l =
                    "svg" === s.nodeName
                      ? {}
                      : q.getComputedStyle(s.parentNode, null)),
                  !i[s.nodeName])
                ) {
                ...
                for (let e in a)
                  (G || V || W || Object.hasOwnProperty.call(a, e)) &&
                    (function (e, o) {
                      if (((h = p = !1), n.length)) {
        ...
        async localExport(e, t) {
          ...
          try {
            let n;
            for (let n of (this.getSVGForExport(e, t), s ? Array.from(s) : []))
              if (
            ...
            let a = ((n = i?.innerHTML), eh.sanitizeSVG(n || "", o));
            if (
              a.indexOf("<foreignObject") > -1 &&
              "image/svg+xml" !== e.type &&
              (V || "application/pdf" === e.type)
            )
              throw Error(
                "Image type not supported for charts with embedded HTML"
              );
            return (
              await this.downloadSVG(a, Z({ filename: this.getFilename() }, e)),
              a
            );
          } catch (t) {
